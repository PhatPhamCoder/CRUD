...
require("./app/routes/module.route")(app);
require("./app/routes/customer.route")(app);
require("./app/routes/sothuebao.route")(app);
require("./app/routes/serithuebao.route")(app);
require("./app/routes/device.route")(app);
require("./app/routes/groupDevice.route")(app);
